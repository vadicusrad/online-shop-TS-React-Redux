...
const Header = () => {
    return (
        <>
            <div className=' h-10 bg-stone-200 flex justify-between items-center px-10 font-light '>
            ...
            <div className='h-28 bg-stone-100 flex justify-between items-center px-10 '>
            ...
            <div className='px-10 h-14 bg-yellow-600 text-white flex items-center space-x-6 font-light'>
                <button className='bg-yellow-500 h-full px-4'>Каталог</button>
                <a href='#'>О компании</a>
                <a href='#'>Контакты</a>
                <a href='#'>Доставка</a>
                <a href='#'>Оплата</a>
