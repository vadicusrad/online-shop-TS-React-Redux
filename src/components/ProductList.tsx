...
const ProductList: React.FC = () => {
    ...
    return loadingStatus ? (
        ...
        <div className='px-5 md:px-10'>
            <div className='container mx-auto grid grid-cols-1  sm:grid-cols-2 md:grid-cols-3  lg:grid-cols-4 justify-items-center gap-4 max-w-7xl py-14 min-h-screen max-h-fit'>
